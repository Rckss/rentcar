    ...
    return (
      <Row>
        <Col md="8">
          ...
          <Button tag={Link} to="/configurations/rent-history" replace color="info">
            <FontAwesomeIcon icon="arrow-left" /> <span className="d-none d-md-inline">Back</span>
          </Button>
          &nbsp;
          <Button tag={Link} to={`/configurations/rent-history/${rentHistoryEntity.id}/edit`} replace color="primary">
