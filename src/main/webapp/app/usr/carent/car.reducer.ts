...
import { defaultValue, ICar } from 'app/shared/model/carent.model';

export const ACTION_TYPES = {
  FETCH_CAR_LIST: 'carent/FETCH_CAR_LIST',
  FETCH_CAR: 'carent/FETCH_CAR',
  CREATE_CAR: 'carent/CREATE_CAR',
  UPDATE_CAR: 'carent/UPDATE_CAR',
  DELETE_CAR: 'carent/DELETE_CAR',
  RESET: 'carent/RESET'
};
...
export type CarentState = Readonly<typeof initialState>;

// Reducer

export default (state: CarentState = initialState, action): CarentState => {
  switch (action.type) {
...
export const getEntity1: ICrudGetAction<ICar> = id => {
