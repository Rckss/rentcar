...
export class ContactDetail extends React.Component<IContactDetailProps> {
  ...
  render() {
    const { contactEntity, photoEntity } = this.props;
    return (
      <Row>
        <Col md="8">
          <h2>
          ...
          <dl className="jh-entity-details">
            ...
            <dt>Photo</dt>
            <dd>{contactEntity.photoId ? contactEntity.photoId : ''}</dd>
            {contactEntity.photoId ? <OnePhoto photo={photoEntity} photoId={contactEntity.photoId} getPhoto={this.props.getPhoto} /> : ''}
          </dl>
...
const mapStateToProps = ({ contact, photo }: IRootState) => ({
