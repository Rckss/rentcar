...
export class AlbumUpdate extends React.Component<IAlbumUpdateProps, IAlbumUpdateState> {
  ...
  handleClose = () => {
    this.props.history.push('/configurations/album');
  };

  render() {
    const { albumEntity, loading, updating } = this.props;
          ...
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : albumEntity} onSubmit={this.saveEntity}>
                ...
                <Button tag={Link} id="cancel-save" to="/configurations/album" replace color="info">
