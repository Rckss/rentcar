...
public class PhotoResourceIntTest {
    ...
    public void setup() {
        ...
        final PhotoResource photoResource = new PhotoResource(photoService, userService);
    ...
    public void getAllPhotosWithEagerRelationshipsIsEnabled() throws Exception {
        PhotoResource photoResource = new PhotoResource(photoServiceMock, userService);
