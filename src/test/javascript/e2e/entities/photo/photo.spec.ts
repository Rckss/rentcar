...
describe('Photo e2e test', () => {
  ...
  it('should load create Photo page', async () => {
    ...
    expect(await photoUpdatePage.getPageTitle().getText()).to.match(/Create or edit a Photo/);
  });
  ...
  it('should create and save Photos', async () => {
    ...
    photoUpdatePage.userSelectLastOption();
  ...
  it('should delete last Photo', async () => {
    ...
    expect(await photoDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/newprjApp.photo.delete.question/);
